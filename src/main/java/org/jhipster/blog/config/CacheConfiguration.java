...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(org.jhipster.blog.domain.Points.class.getName(), jcacheConfiguration);
            cm.createCache(org.jhipster.blog.domain.Preferences.class.getName(), jcacheConfiguration);
            cm.createCache(org.jhipster.blog.domain.Weight.class.getName(), jcacheConfiguration);
